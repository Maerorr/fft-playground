    ...
    create_vizia_editor(editor_state, ViziaTheming::Custom, move |cx, _| {
        ...
        VStack::new(cx, |cx| {
            ...
            HStack::new(cx, |cx| {
                ...
                ParamButton::new(cx, EditorData::plugin_data, |params| &params.stereo_link);
            ...
            HStack::new(cx, |cx| {
                Binding::new(cx, EditorData::plugin_data.map(|val| val.freeze_magnitudes.value()), |cx, lens| {
                    ...
                    if !value {
                        ...
                        HStack::new(cx, |cx| {
                            Label::new(cx, "Changing FFT Size while\n  frozen not supported.")
