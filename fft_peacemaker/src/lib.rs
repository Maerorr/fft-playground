...
impl Plugin for PluginData {
    const NAME: &'static str = "fft_peacemaker";
...
impl ClapPlugin for PluginData {
    const CLAP_ID: &'static str = "fft_peacemaker";
    const CLAP_DESCRIPTION: Option<&'static str> = Some("fft_peacemaker");
...
impl Vst3Plugin for PluginData {
    const VST3_CLASS_ID: [u8; 16] = *b"fft_peacemaker__";
